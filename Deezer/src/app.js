...
var spotifyRedirectUri = 'http://localhost:8080/spotifyCallback';

var deezerStateKey = 'deezer_auth_state';
var deezerCallbackUri = 'http://localhost:8080/deezerCallback';

/**
 * Genera un String aleatorio de numeros y letras
 * @param  {number} length La longitud del String
